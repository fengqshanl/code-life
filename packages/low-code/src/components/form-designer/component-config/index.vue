<template>
  ...
  >
    <el-container class="panel-container">
      ...
      <div
        v-if="showWidgetEventDialog2Flag"
        class=""
        v-drag="['.drag-dialog.el-dialog', '.drag-dialog .el-dialog__header']"
      >
        <el-dialog
          :title="i18nt('designer.setting.editWidgetEventHandler')"
          v-model="showWidgetEventDialog2Flag"
          :show-close="true"
          class="drag-dialog small-padding-dialog"
          append-to-body
          :close-on-click-modal="false"
...
import PropertyEditors from "../setting-panel/property-editor/index";
import FormSetting from "../setting-panel/form-setting.vue";
