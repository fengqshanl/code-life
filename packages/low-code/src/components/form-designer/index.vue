<template>
  <el-container class="main-container full-height">
    <el-header class="main-header">
      <el-button @click="createApp">创建一个应用</el-button>
    ...
    <CreateAppDialog v-model="createVisible" />
...
import TemporaryComponents from './temporary-components/index'
...
import ComponentConfig from './component-config/index.vue'
...
export default {
  ...
  methods: {
    changeVisible(val) {
      console.log(this, 'this - changeVisible')
      this.visible = val
    },
