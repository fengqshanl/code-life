<template>
  <el-container class="panel-container">
    ...
    <div v-if="showWidgetEventDialog2Flag" class="" v-drag="['.drag-dialog.el-dialog', '.drag-dialog .el-dialog__header']">
      <el-dialog :title="i18nt('designer.setting.editWidgetEventHandler')" v-model="showWidgetEventDialog2Flag"
                 :show-close="true" class="drag-dialog small-padding-dialog" append-to-body
                 :close-on-click-modal="false" :close-on-press-escape="false" :destroy-on-close="true">
        <code-editor :mode="'javascript'" :readonly="false" v-model="eventHandlerCode" ref="ecEditor" />
        <template #footer>
          <div class="dialog-footer">
            <el-button @click="showWidgetEventDialog2Flag = false">
  ...
  export default {
    ...
    data() {
      return {
        ...
        showWidgetEventDialog2Flag: false,
        eventHandlerCode: '',
        curEventName: '',
        eventHeader: '',
    ...
    created() {
      ...
      this.on$('editEventHandler', (eventParams) => {
        //debugger
        this.editEventHandler(eventParams[0], eventParams[1], eventParams[2])
      })
    ...
    methods: {
      ...
      editEventHandler(eventName, eventParams, eventTag) {
        //debugger
        ...
        if (eventTag) {
          this.showWidgetEventDialog2Flag = true
        } else {
